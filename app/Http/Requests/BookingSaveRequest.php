...
class BookingSaveRequest extends FormRequest
{
    ...
    public function rules()
    {
        return  [
            ...
            "hotelJPCode" => 'nullable|string',
            "hotelIntCode" => 'nullable|string',
            "hotelLocator" => 'nullable|string',
            "finalBookHotelFormData" => 'nullable|numeric',
            "finalBookHotelsFormData" => 'nullable|array',
            "finalBookHotelsFormData.*" => 'nullable|numeric',
            "hotelJPCodes" => 'nullable|array',
            "hotelJPCodes.*" => 'nullable|string',
            "hotelStartDates" => 'nullable|array',
            "hotelStartDates.*" => 'nullable|date',
            "hotelEndDates" => 'nullable|array',
            "hotelEndDates.*" => 'nullable|date',
            "hotelIntCodes" => 'nullable|array',
            "hotelIntCodes.*" => 'nullable|string',
            "hotelLocators" => 'nullable|array',
            "hotelLocators.*" => 'nullable|string',
            // "sessionId"                                 => 'required',
       ];
    }
}
